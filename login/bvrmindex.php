...
<body>
    ...
    <table id="userTable" style="display:none;">
        ...
        <?php
            echo "<br><br><p style='font-size: 28px; text-align: center;'>welcome to <b>Bhiamavarm Hospitals</b> DataBase";
       ...
       // PHP code for fetching data from the database.
        ...
        $sql = "SELECT department ,DoctorName ,date ,time ,name ,phone ,message FROM bhimavaram";
