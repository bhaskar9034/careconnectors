...
<body>
    ...
    <table id="userTable" style="display:none;">
        ...
        <?php
            echo "<br><br><p style='font-size: 28px; text-align: center;'>welcome to <b>Sadhana Hospitals</b> DataBase";
        ...
        $sql = "SELECT department ,DoctorName ,date ,time ,name ,phone ,message FROM sadhana";
