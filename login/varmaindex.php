...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Care connectors &amp; Medical pvt ltd</title>
...
<body>
    ...
    <table id="userTable" style="display:none;">
        ...
        <?php
            echo "<br><br><p style='font-size: 28px; text-align: center;'>welcome to <b>Varma Hospitals</b> DataBase";
        ...
        $sql = "SELECT department ,DoctorName ,date ,time ,name ,phone ,message FROM updated";
    ...
    <script>
        ...
        function hideTable() {
            ...
            // Clear the row count when hiding the table
        }
    </script>
</body>
</html>
